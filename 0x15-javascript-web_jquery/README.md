...
JavaScript
 ...
 Manual QA review was done by Ishaq Lagnaoui on Feb 7, 2024 12:44 PM
Concepts
...
HTML should not reload for each action: DOM manipulation, update values, fetch More Info
Import JQuery
<head>
...
#advanced
Score: 100.0% (Checks completed: 100.0%)
Write a JavaScript script that fetches and prints how to  depending on the language
...
Directory: 0x15-javascript-web_jquery
File: 103-script.js
 canHelloof Hellosay canHelloof Hellosay cancancanhelloof cancancancancancancancancanprojectdataelsedonAPI